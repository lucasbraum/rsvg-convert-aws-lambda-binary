sudo yum install shared-mime-info cairo cairo-devel cairo-gobject-devel gobject-introspection gobject-introspection-devel giflib-devel libjpeg-turbo-devel poppler-glib-devel harfbuzz-devel -y

export PKG_CONFIG_PATH=/home/ubuntu/build/lib/pkgconfig:/usr/lib64/pkgconfig:/usr/lib/pkgconfig
rm -rf build *.pdf
...
cd libcroco-0.6.12
./configure --prefix=/home/ubuntu/build --disable-shared --enable-static
make && make install 
cd ..
...
cd pango-1.40.10
./configure --prefix=/home/ubuntu/build --with-included-modules --disable-shared --enable-static
make && make install 
cd ..
...
./configure --prefix=/home/ubuntu/build --without-gdiplus --disable-modules --with-included-loaders=yes --disable-shared --enable-static
make && make install
cd ..
